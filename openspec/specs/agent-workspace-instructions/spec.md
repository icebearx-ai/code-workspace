# agent-workspace-instructions Specification

## Purpose
Define client-discoverable, consistently rendered workspace instructions and a safe, shared recovery workflow for project branch mismatches.
