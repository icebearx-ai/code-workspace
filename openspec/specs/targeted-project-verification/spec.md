# targeted-project-verification Specification

## Purpose
Define optional project-scoped verification that isolates unrelated runtime failures while preserving relevant configuration diagnostics and stable CLI behavior.
