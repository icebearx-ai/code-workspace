...
async function main() {
  ...
  if (context.schemaVersion !== 1 || context.extensionSpecVersion !== 1 || context.extension?.id !== "zhuiyi-opensvn-mcp" || context.extension.version !== "0.1.0" || !Array.isArray(context.tools)) throw new Error("Invalid extension context");
  ...
  fs.writeFileSync(resultFile, `${JSON.stringify({
    ...
    extension: { id: "zhuiyi-opensvn-mcp", version: "0.1.0" },
    outputs,
  }, null, 2)}\n`, { mode: 0o600 });
}
