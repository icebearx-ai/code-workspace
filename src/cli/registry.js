...
const COMMAND_SUMMARIES = {
  ...
  "project sync-branch": "Update a registered project branch from its Git worktree",
...
const COMMANDS = [
  ...
  { path: ["project", "sync-branch"], args: [{ name: "name", required: true }], workspace: "required", config: ["projects"], interaction: "required", effects: "planned-write", options: { yes: { type: "boolean" } } },
