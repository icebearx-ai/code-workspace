...
const COMMAND_SUMMARIES = {
  ...
  "task list": "List coordinated Agent tasks",
  "task show": "Show one coordinated task",
  "task lock list": "List coordinated task claims",
  "task decision show": "Show a pending task decision",
  "task decision keep": "Keep a task claim or project guard",
  "task decision approve": "Approve non-overlapping project parallelism",
  "task decision release": "Release an UNKNOWN dirty claim",
  "task decision abandon": "Abandon an UNKNOWN task generation",
...
const COMMANDS = [
  ...
  { path: ["task", "list"], args: [], workspace: "required", config: ["identity", "projects"], interaction: "never", effects: "read-only", options: {} },
  { path: ["task", "show"], args: [{ name: "task-id", required: true }], workspace: "required", config: ["identity", "projects"], interaction: "never", effects: "read-only", options: {} },
  { path: ["task", "lock", "list"], args: [], workspace: "required", config: ["identity", "projects"], interaction: "never", effects: "read-only", options: {} },
  { path: ["task", "decision", "show"], args: [{ name: "request-id", required: true }], workspace: "required", config: ["identity", "projects"], interaction: "never", effects: "read-only", options: {} },
  { path: ["task", "decision", "keep"], args: [{ name: "request-id", required: true }], workspace: "required", config: ["identity", "projects"], interaction: "required", effects: "planned-write", options: { yes: { type: "boolean" } } },
  { path: ["task", "decision", "approve"], args: [{ name: "request-id", required: true }], workspace: "required", config: ["identity", "projects"], interaction: "required", effects: "planned-write", options: { yes: { type: "boolean" } } },
  { path: ["task", "decision", "release"], args: [{ name: "request-id", required: true }], workspace: "required", config: ["identity", "projects"], interaction: "required", effects: "planned-write", options: { yes: { type: "boolean" } } },
  { path: ["task", "decision", "abandon"], args: [{ name: "request-id", required: true }], workspace: "required", config: ["identity", "projects"], interaction: "required", effects: "planned-write", options: { yes: { type: "boolean" } } },
